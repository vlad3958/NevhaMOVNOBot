...
namespace NevhaWebHook.Controllers
{
    [ApiController]
    [Route("[controller]")]
        ...
        public async Task<IActionResult> Bot([FromBody] Update update)
        {
            ...
            if (message != null)
            {
                if (message.Type == MessageType.Text)
                {
                    ...
                    if (message.Text == "Хочу записатись!(5-10 класи)")
                    {
                        var replyKeyboardMarkup = new ReplyKeyboardMarkup(new[]
                        {
                            new KeyboardButton[] { "Форма заповнена! Що далі?" },
                        ...
                        await botClient.SendTextMessageAsync(message.Chat.Id, "" +
                                                                              "Дайте відповідь на кілька запитань у цьому опитувальнику: https://forms.gle/zmiu9QtT2yVs1Seb8  Вони допоможуть нам визначити для вас наставницю з української мови та сформувати програму розвитку. Орієнтовний час заповнення 7-10 хвилин.",
                            replyMarkup: replyKeyboardMarkup);
                    }
                    if (message.Text == "Хочу записатись!(ЗНО/НМТ)")
                    {
                        ...
                        await botClient.SendTextMessageAsync(message.Chat.Id, "" +
                                                                              "Дайте відповідь на кілька запитань у цьому опитувальнику: https://forms.gle/2LEUsnVSp51kQmYv6  Вони допоможуть нам визначити для вас наставницю з української мови та сформувати програму розвитку. Орієнтовний час заповнення 7-10 хвилин.",
                            replyMarkup: replyKeyboardMarkup);
                    }
                    if (message.Text == "Хочу записатись!(для дорослих)")
                    {
                        var replyKeyboardMarkup = new ReplyKeyboardMarkup(new[]
                        {
                            new KeyboardButton[] { "Форма заповнена! Що далі?" },
                        ...
                        await botClient.SendTextMessageAsync(message.Chat.Id, "" +
                                                                              "Дайте відповідь на кілька запитань у цьому опитувальнику: https://forms.gle/uMWVCG7azesk37D67  Вони допоможуть нам визначити для вас наставницю з української мови та сформувати програму розвитку. Орієнтовний час заповнення 7-10 хвилин.",
                            replyMarkup: replyKeyboardMarkup);
                    }
                    ...
                    if (message.Text == "🟡українська для учнів 5-10 класів")
                    {
                        var replyKeyboardMarkup = new ReplyKeyboardMarkup(new[]
                        {
                            new KeyboardButton[] { "Хочу записатись!(5-10 класи)", "Мені потрібна ще додаткова інформація" },
                        });
                    ...
                    if (message.Text == "🟡підготовка до ЗНО/НМТ з української мови")
                    {
                        ...
                        await botClient.SendTextMessageAsync(message.Chat.Id, "" +
                                                                              ...
                                                                              "600 грн/1,5 год заняття\n\n" +

                                                                              "Групові заняття (у групі до 6 людей)\n" +
                                                                              "   💳 Ціна: 250 грн/1,5 год заняття (2 рази на тиждень)\n\n"+
                            "Вивчення блоку \"Фонетика\" + \"Орфографія\" (у групі)\n"+
                                "💳 Ціна: 2000 грн\n"+
                            "Тривалість: 2 місяці (8 занять)",replyMarkup: replyKeyboardMarkup);
                    ...
                    if (message.Text == "🟡українська для дорослих")
                    {
                        var replyKeyboardMarkup = new ReplyKeyboardMarkup(new[]
                        {
                            new KeyboardButton[] { "Хочу записатись!(для дорослих)", "Мені потрібна ще додаткова інформація" },
                        });
                    ...
                    if (message.Text == "I want to apply!")
                    {
                        ...
                        await botClient.SendTextMessageAsync(message.Chat.Id,
                            "Please, fill the form: https://forms.gle/vGJ8ercwCt6fMpUY9  It’ll help us to understand your goals and develop your personal learning plan. Approximate filling time is 7-10 minutes.",
                            replyMarkup: replyKeyboardMarkup);
